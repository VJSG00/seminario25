...
class DecayStep(models.Model):
    ...
    decay_mode = models.CharField(max_length=100)
...
class Reaction(models.Model):
    ...
    api = models.CharField(max_length=50, db_column='api')
    author = models.CharField(max_length=200, db_column='author')
    reference = models.CharField(max_length=200, db_column='reference')
    target = models.CharField(max_length=50, db_column='target')
    product = models.CharField(max_length=50, db_column='product')
    projectile = models.CharField(max_length=50, db_column='projectile')
    emission = models.CharField(max_length=50, db_column='emission')
...
class ReactionMeasurement(models.Model):
    ...
    E_ev = models.FloatField(db_column='E,ev')
    Sig_b = models.FloatField(db_column='Sig,b')
    dSig_b = models.FloatField(db_column='dSig,b')
